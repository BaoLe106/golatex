...
--
-- Name: file_info; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.file_info OWNER TO admin;

--
-- Name: project_info; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.project_info OWNER TO admin;
...
--
-- Name: user_project; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.user_project OWNER TO admin;

--
-- Data for Name: file_info; Type: TABLE DATA; Schema: public; Owner: admin
--
...
--
-- Data for Name: project_info; Type: TABLE DATA; Schema: public; Owner: admin
--
...
--
-- Data for Name: user_project; Type: TABLE DATA; Schema: public; Owner: admin
--
...
--
-- Name: file_info file_info_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: project_info project_info_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: file_info file_info_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: user_project user_project_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: user_project user_project_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
